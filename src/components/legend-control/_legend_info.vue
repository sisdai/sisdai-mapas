<template>
  <div class="boton-info" @mouseover="show = true" @mouseleave="show = false">
    <svg
      version="1.1"
      id="Capa_1"
      ...
      <g id="Componente_35_25" transform="translate(0.5 0.5)">
        ...
        <g id="Grupo_11228" transform="translate(6 3)">
          <path
            id="Trazado_30342"
            class="st1"
            d="M2.9,8V3.4H0.6v1.1h1.1V8H0v1.1h4.6V8H2.9z"
          />
          <path
            id="Trazado_30343"
            class="st1"
            d="M1.9,0C1.4,0,1,0.4,1,0.9s0.4,0.9,0.9,0.9c0.5,0,0.9-0.4,0.9-0.9S2.3,0,1.9,0L1.9,0z"
          />
        </g>
      </g>
    </svg>
  ...
  watch: {
    show(nv) {
      if (nv) {
        ...
        if (this.lado === "izquierdo") {
          tooltip.classList.add(this.lado);
        }
        ...
        if (this.lado === "derecho") {
          tooltip.setAttribute(
            "style",
            `transform: translate(${position.left + width + 16}px, ${
              position.top + window.scrollY + height / 2
            }px) translateY(-50%)`
          );
        } else {
          tooltip.setAttribute(
            "style",
            `transform: translate(${
              position.right - width - 16 - tooltip.clientWidth
            }px, ${
              position.top + window.scrollY + height / 2
            }px) translateY(-50%)`
          );
